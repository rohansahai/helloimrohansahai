...
$(document).ready(function(){
	...
	$window = $(window);
	var lefty=($(window).width()-640)/2;
	var top=$(window).height()/2;
	//$('#logo').css('left',lefty-20+'px');
	//$('#logo').css('top',top+'px');
...
function parallaxScroll(){
    ...
    $('#logo').css('top',(220-(scrolled*.25))+'px');
    
    
    if (scrolled > 700){
    	if (banana==1){
    		var tag = document.getElementById("logo");
    		tag.innerHTML = '<img src="ah.png">';
    		banana=banana-1;
    	}
    }
    ...
    if (scrolled < 699 ){
    	if (banana==0){
    		var tag = document.getElementById("logo");
    		tag.innerHTML = '<img src="Rohan-Sahai-Logo2.png">';
    		banana=banana+1;
    	}
    }
...
audioElement2.setAttribute('src', 'audio/d3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement3 = document.createElement('audio');
audioElement3.setAttribute('src', 'audio/e3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement4 = document.createElement('audio');
audioElement4.setAttribute('src', 'audio/f3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement5 = document.createElement('audio');
audioElement5.setAttribute('src', 'audio/g3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement6 = document.createElement('audio');
audioElement6.setAttribute('src', 'audio/a4.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement7 = document.createElement('audio');
audioElement7.setAttribute('src', 'audio/b4.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement8 = document.createElement('audio');
audioElement8.setAttribute('src', 'audio/c4.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement1_5 = document.createElement('audio');
audioElement1_5.setAttribute('src', 'audio/csharp3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement2_5 = document.createElement('audio');
audioElement2_5.setAttribute('src', 'audio/dsharp3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement4_5 = document.createElement('audio');
audioElement4_5.setAttribute('src', 'audio/fsharp3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement5_5 = document.createElement('audio');
audioElement5_5.setAttribute('src', 'audio/gsharp3.mp3');
audioElement1.setAttribute('onended', 'keyOff()');

var audioElement6_5 = document.createElement('audio');
audioElement6_5.setAttribute('src', 'audio/asharp4.mp3');
audioElement1.setAttribute('onended', 'keyOff()');
